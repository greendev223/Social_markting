...
const SignupFormModal = ({ hideSignupForm, showlogin, closesignup }: Props) => {
  const {
    register,
    watch,
    formState: { errors },
    ...
    <div className="login-form-wrapper">
      ...
      >
        <div className="form-group">
          ...
          />
          {errors.firstName?.message && <div className="invalid-feedback">{errors.firstName.message}</div>}
        </div>
        <div className="form-group">
          <img src="/assets/img/login/user.svg" />
          <input
          ...
          />
          {errors.lastName?.message && <div className="invalid-feedback">{errors.lastName.message}</div>}
        </div>
        <div className="form-group">
      ...
      <p className="already">
        Already have account? <a onClick={() => gotoLogin()}>Login</a>
      </p>
    </div>
  )
}
