          ...
          <Col sm={24} md={8}>
            <div className="part md:-mt-32">
                ...
                <div className="text-center mt-4 md:pl-20">
                  <div className="text-18 md:text-lg font-medium md:text-left">Seamlessly Share photos and content</div>
                  <div className="text-12 md:text-base font-normal pt-3 text-gray-500 md:text-left" >Bluejestic brings friends and family together through a highly engaging shopping platform</div>
                  <div className="md:text-left mt-8"><button className="text-blue-500 text-12 md:text-18 font-medium mt-4 ">Learn More</button></div>
                </div> 
            </div>
          </Col>
          <Col sm={24} md={8}>
            <div className="part md:mt-16" >
                ...
                <div className="text-center mt-4 ">
                  <div className="text-18 md:text-lg font-medium md:text-left">Conversational Shopping</div>
                  <div className="text-12 md:text-base font-normal pt-3 text-gray-500 md:text-left" >Get to know your followers, </div>
                  <div className="md:text-left mt-8"><button className="text-blue-500 text-12 md:text-18 font-medium mt-4 ">Learn More</button></div>
                </div> 
            </div>
          </Col>
          <Col sm={24} md={8}>
            <div className="part md:mt-60">
                ...
                <div className="text-center md:-mt-16 md:-mr-20 ">
                  <div className="text-18 md:text-lg font-medium md:text-left">Active Community</div>
                  <div className="text-12 md:text-base font-normal pt-3 text-gray-500 md:text-left" >Bluejestic brings friends and family together through a highly engaging shopping platform</div>
                  <div className="md:text-left mt-8"><button className="text-blue-500 text-12 md:text-18 font-medium mt-4 ">Learn More</button></div>
                </div> 
            </div>
